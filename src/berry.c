...
//.rodata
static const u8 sBerryDescriptionPart1_Cheri[] = _("Florece com belas e delicadas flores.");
static const u8 sBerryDescriptionPart2_Cheri[] = _("É de cor vermelha e sabor picante.");
static const u8 sBerryDescriptionPart1_Chesto[] = _("Possui sua casca e os frutos duros.");
static const u8 sBerryDescriptionPart2_Chesto[] = _("Näo é nada saboroso por ser bem seco.");
static const u8 sBerryDescriptionPart1_Pecha[] = _("Muito doce e deliciosa.");
static const u8 sBerryDescriptionPart2_Pecha[] = _("É muito delicada -  näo aperte.");
static const u8 sBerryDescriptionPart1_Rawst[] = _("Se as folhas crescem muito longas, o");
static const u8 sBerryDescriptionPart2_Rawst[] = _("sabor desta Berry ficará muito amarga.");
static const u8 sBerryDescriptionPart1_Aspear[] = _("Esta Berry é dura e densa. Da muito");
static const u8 sBerryDescriptionPart2_Aspear[] = _("suco. É bastante ácida.");
static const u8 sBerryDescriptionPart1_Leppa[] = _("Cresce mais lento do que os outros.");
static const u8 sBerryDescriptionPart2_Leppa[] = _("Quanto menor, mais saborosa será.");
static const u8 sBerryDescriptionPart1_Oran[] = _("É uma boa Berry com mescla de sabores.");
static const u8 sBerryDescriptionPart2_Oran[] = _("Leva 12 horas para seu fruto crescer.");
static const u8 sBerryDescriptionPart1_Persim[] = _("Ama o sol. Se está exposta a ele,");
static const u8 sBerryDescriptionPart2_Persim[] = _("a cor de sua casca intensifica.");
static const u8 sBerryDescriptionPart1_Lum[] = _("Cresce devagar. Se cuidar com amor,");
static const u8 sBerryDescriptionPart2_Lum[] = _("carinho, pode dar 2 Berries.");
static const u8 sBerryDescriptionPart1_Sitrus[] = _("É da mesma familïa da laranja. Tem");
static const u8 sBerryDescriptionPart2_Sitrus[] = _("um sabor bastante reconhecido.");
static const u8 sBerryDescriptionPart1_Figy[] = _("Seu fruto parece está mastigado,");
static const u8 sBerryDescriptionPart2_Figy[] = _("sua polpa tem sabor intenso.");
static const u8 sBerryDescriptionPart1_Wiki[] = _("Dizem que cresce granulosa para os");
static const u8 sBerryDescriptionPart2_Wiki[] = _("Pokémon segurar melhor.");
static const u8 sBerryDescriptionPart1_Mago[] = _("Vai curvando durante crescimento e");
static const u8 sBerryDescriptionPart2_Mago[] = _("isso deixa mais doce e bem saborosa.");
static const u8 sBerryDescriptionPart1_Aguav[] = _("A flor é esquisita. sua habilidade para");
static const u8 sBerryDescriptionPart2_Aguav[] = _("crescer sem luz lhe faz única.");
static const u8 sBerryDescriptionPart1_Iapapa[] = _("Seu fruto é muito grande e ácido.");
static const u8 sBerryDescriptionPart2_Iapapa[] = _("Leva até 1 dia para crescer.");
static const u8 sBerryDescriptionPart1_Razz[] = _("Uma Berry vermelha e de sabor picante.");
static const u8 sBerryDescriptionPart2_Razz[] = _("Cresce bem rápido, até em 4 horas.");
static const u8 sBerryDescriptionPart1_Bluk[] = _("Por fora é de cor azul, mas pintará");
static const u8 sBerryDescriptionPart2_Bluk[] = _("de negro a sua boca se a comer.");
static const u8 sBerryDescriptionPart1_Nanab[] = _("É a 7º Berry a ser descoberta");
static const u8 sBerryDescriptionPart2_Nanab[] = _("em todo o mundo. É muito saboroso.");
static const u8 sBerryDescriptionPart1_Wepear[] = _("A flor é pequena e branca. Tem gosto");
static const u8 sBerryDescriptionPart2_Wepear[] = _("bem ácido e amargo ao mesmo tempo.");
static const u8 sBerryDescriptionPart1_Pinap[] = _("É fágil com vento e o frio.");
static const u8 sBerryDescriptionPart2_Pinap[] = _("A polpa é picante; e a casca, ácida.");
static const u8 sBerryDescriptionPart1_Pomeg[] = _("Se usar a mesma quantidade");
static const u8 sBerryDescriptionPart2_Pomeg[] = _("de água crescem 6 Berries sempre.");
static const u8 sBerryDescriptionPart1_Kelpsy[] = _("É uma especie bem rara. Tem forma");
static const u8 sBerryDescriptionPart2_Kelpsy[] = _("de raïz sua flor é grande.");
static const u8 sBerryDescriptionPart1_Qualot[] = _("Ama água. Cresce mais forte em");
static const u8 sBerryDescriptionPart2_Qualot[] = _("locais com constantes chuvas.");
static const u8 sBerryDescriptionPart1_Hondew[] = _("É uma Berry carisima e muito pouca");
static const u8 sBerryDescriptionPart2_Hondew[] = _("frequente. É delicioso e bem raro.");
static const u8 sBerryDescriptionPart1_Grepa[] = _("É macia e redondinha, mas de uma");
static const u8 sBerryDescriptionPart2_Grepa[] = _("acidez incrïvel e sabor único.");
static const u8 sBerryDescriptionPart1_Tamato[] = _("Está é täo picante que faz arder.");
static const u8 sBerryDescriptionPart2_Tamato[] = _("Cresce muito devagar.");
static const u8 sBerryDescriptionPart1_Cornn[] = _("Uma Berry de uma era antiga. Difïcil ");
static const u8 sBerryDescriptionPart2_Cornn[] = _("crescer se näo plantar muitas.");
static const u8 sBerryDescriptionPart1_Magost[] = _("Uma Berry que todo mundo diz que");
static const u8 sBerryDescriptionPart2_Magost[] = _("guarda um equilibrio de sabores.");
static const u8 sBerryDescriptionPart1_Rabuta[] = _("Variedade muito pouco comum, tem pelo");
static const u8 sBerryDescriptionPart2_Rabuta[] = _("seu sabor e muito amargo.");
static const u8 sBerryDescriptionPart1_Nomel[] = _("É bem ácida. Apenas uma pode fazer");
static const u8 sBerryDescriptionPart2_Nomel[] = _("ficar sem paladar durante 3 dias.");
static const u8 sBerryDescriptionPart1_Spelon[] = _("É de cor vermelho forte bem picante.");
static const u8 sBerryDescriptionPart2_Spelon[] = _("Tem casca granulada e bem macia.");
static const u8 sBerryDescriptionPart1_Pamtre[] = _("Ninguém sabe a sua procedencia.");
static const u8 sBerryDescriptionPart2_Pamtre[] = _("Ela flutua a deriva pelo mar.");
static const u8 sBerryDescriptionPart1_Watmel[] = _("É enorme. Algumas mede mais de");
static const u8 sBerryDescriptionPart2_Watmel[] = _("meio metro. É extremamente doce.");
static const u8 sBerryDescriptionPart1_Durin[] = _("Resulta de um sabor bem amargo.");
static const u8 sBerryDescriptionPart2_Durin[] = _("Ninguém se atreve a provar sozinha.");
static const u8 sBerryDescriptionPart1_Belue[] = _("É brilhante e tem uma boa aperência,");
static const u8 sBerryDescriptionPart2_Belue[] = _("mas é super ácida. Demora a crescer.");
static const u8 sBerryDescriptionPart1_Chilan[] = _("Pode ser transformado em um apito");
static const u8 sBerryDescriptionPart2_Chilan[] = _("que produz um som indescritível.");
static const u8 sBerryDescriptionPart1_Occa[] = _("Boatos de que ela cresce nos tópicos,");
static const u8 sBerryDescriptionPart2_Occa[] = _("onde se ostenta um clima quente.");
static const u8 sBerryDescriptionPart1_Passho[] = _("É pontilhada com pontos minúsculos");
static const u8 sBerryDescriptionPart2_Passho[] = _("que o permite ficar na água.");
static const u8 sBerryDescriptionPart1_Wacan[] = _("Sua energia é extraída de raios");
static const u8 sBerryDescriptionPart2_Wacan[] = _("fazendo-a crescer grande e forte.");
static const u8 sBerryDescriptionPart1_Rindo[] = _("Esta Berry possui um sabor vegetal,");
static const u8 sBerryDescriptionPart2_Rindo[] = _("mas é rico em fibras, boa para saúde.");
static const u8 sBerryDescriptionPart1_Yache[] = _("Esta Berry tem um refrescante sabor seco");
static const u8 sBerryDescriptionPart2_Yache[] = _("e azedo. O gosto é melhor como refresco.");
static const u8 sBerryDescriptionPart1_Chople[] = _("Contém uma substância que gera calor");
static const u8 sBerryDescriptionPart2_Chople[] = _("Pode até despertar um coraçäo frio.");
static const u8 sBerryDescriptionPart1_Kebia[] = _("Verde brilhante por fora, por dentro");
static const u8 sBerryDescriptionPart2_Kebia[] = _("a sua carne é de cor preta.");
static const u8 sBerryDescriptionPart1_Shuca[] = _("Sua polpa é doce, e apenas uma mordida");
static const u8 sBerryDescriptionPart2_Shuca[] = _("revelará sua dureza e perfume.");
static const u8 sBerryDescriptionPart1_Coba[] = _("É dito que esta Berry é uma fusäo");
static const u8 sBerryDescriptionPart2_Coba[] = _("de outras duas Berries desconhecidas.");
static const u8 sBerryDescriptionPart1_Payapa[] = _("Ao sentir emoçöes humanas, ela incha");
static const u8 sBerryDescriptionPart2_Payapa[] = _("e também quando alguém se aproxima.");
static const u8 sBerryDescriptionPart1_Tanga[] = _("Ela cultiva uma flor na ponta que atrai");
static const u8 sBerryDescriptionPart2_Tanga[] = _("Pokémon insetos com suas pétalas.");
static const u8 sBerryDescriptionPart1_Charti[] = _("Muitas vezes usada por causa de seu");
static const u8 sBerryDescriptionPart2_Charti[] = _("sabor seco. As vezes comido cru.");
static const u8 sBerryDescriptionPart1_Kasib[] = _("É dito que ela possui um estranho");
static const u8 sBerryDescriptionPart2_Kasib[] = _("poder. Um popular amuleto de boa-sorte.");
static const u8 sBerryDescriptionPart1_Haban[] = _("Menor sabor amargo em menos tamanhos.");
static const u8 sBerryDescriptionPart2_Haban[] = _("Dá para fazer uma boa geleia.");
static const u8 sBerryDescriptionPart1_Colbur[] = _("Diz-se que ele se prende a um ");
static const u8 sBerryDescriptionPart2_Colbur[] = _("Pokémon com seus pequenos ganchos.");
static const u8 sBerryDescriptionPart1_Babiri[] = _("Esta Berry é muito duro com um");
static const u8 sBerryDescriptionPart2_Babiri[] = _("sabor forte. Usado na medicina.");
static const u8 sBerryDescriptionPart1_Roseli[] = _("Uma Berry que pode ser usada para");
static const u8 sBerryDescriptionPart2_Roseli[] = _("chá de ervas e pratos sofisticados.");
static const u8 sBerryDescriptionPart1_Liechi[] = _("É misteriosa. Todos dizem que ela");
static const u8 sBerryDescriptionPart2_Liechi[] = _("contém a força do mar.");
static const u8 sBerryDescriptionPart1_Ganlon[] = _("É misteriosa. Rumores dizem que ela");
static const u8 sBerryDescriptionPart2_Ganlon[] = _("contém a força da terra.");
static const u8 sBerryDescriptionPart1_Salac[] = _("É muito rara. Rumores dizem que ela");
static const u8 sBerryDescriptionPart2_Salac[] = _("contém a força do céu.");
static const u8 sBerryDescriptionPart1_Petaya[] = _("É misteriosa. Todos dizem que ela");
static const u8 sBerryDescriptionPart2_Petaya[] = _("contém a força da vida.");
static const u8 sBerryDescriptionPart1_Apicot[] = _("É extranha. Näo se sabe que efeitos");
static const u8 sBerryDescriptionPart2_Apicot[] = _("pode ter nela, e como pode usar-lá.");
static const u8 sBerryDescriptionPart1_Lansat[] = _("Dizem ser uma Berry Lendária.");
static const u8 sBerryDescriptionPart2_Lansat[] = _("Pode dá felicidade a que segura.");
static const u8 sBerryDescriptionPart1_Starf[] = _("É täo forte que a deixaram perdida");
static const u8 sBerryDescriptionPart2_Starf[] = _("pelo mundo. Será verdade isso?");
static const u8 sBerryDescriptionPart1_Enigma[] = _("É inigmática. Dizem que traz");
static const u8 sBerryDescriptionPart2_Enigma[] = _("a força maior das estrelas.");
static const u8 sBerryDescriptionPart1_Micle[] = _("Tem o efeito de tornar doce o");
static const u8 sBerryDescriptionPart2_Micle[] = _("sabor de outros alimentos");
static const u8 sBerryDescriptionPart1_Custap[] = _("A carne por baixo da pele dura");
static const u8 sBerryDescriptionPart2_Custap[] = _("do Custap Berry é doce e cremosa.");
static const u8 sBerryDescriptionPart1_Jaboca[] = _("Uma Berry muito rara. Ela precisa");
static const u8 sBerryDescriptionPart2_Jaboca[] = _("ser manuseada cuidadosamente");
static const u8 sBerryDescriptionPart1_Rowap[] = _("Uma Berry muito rara. É täo amarga");
static const u8 sBerryDescriptionPart2_Rowap[] = _("que pode fazer as pessoas chorarem");
static const u8 sBerryDescriptionPart1_Kee[] = _("Uma Berry ligeiramente rara.");
static const u8 sBerryDescriptionPart2_Kee[] = _("Possui uma aparência apimentada.");
static const u8 sBerryDescriptionPart1_Maranga[] = _("Uma Berry ligeiramente rara. Seu");
static const u8 sBerryDescriptionPart2_Maranga[] = _("exterior é armago, e interior doce.");
