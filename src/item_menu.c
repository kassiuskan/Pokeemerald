...
static const u8 sMenuText_ByName[] = _("Nome");
static const u8 sMenuText_ByType[] = _("Tipo");
static const u8 sMenuText_ByAmount[] = _("Quant.");
static const u8 sMenuText_ByNumber[] = _("Numero");
...
static const u8 sText_SortItemsHow[] = _("Como quer \norganizar os itens?");
static const u8 sText_Name[] = _("Nome");
static const u8 sText_Type[] = _("Tipo");
static const u8 sText_Amount[] = _("Quant.");
static const u8 sText_ItemsSorted[] = _("Itens organizados por {STR_VAR_1}!");
...
//AQUI Criar função para medicine battle item e tesouros
...
static const u16 sTreasuresByType[ITEMS_COUNT] =
{
	//POCKET_TREASURES
...
static const u16 sBattleItemsByType[ITEMS_COUNT] =
{
	//POCKET_BATTLE_ITEMS
...
static const u16 sMedicineByType[ITEMS_COUNT] =
{
	//medicine
