...
#define SUNSET_END_HOUR     18      //17 - 18
#define NIGHTFALL_END_HOUR  19      //18 - 19
#define NIGHT_END_HOUR      0       //19 - 00
...
static const u16 gMidnightFilters[] =
{
    RGB2(14, 14, 6),    //CE19
    RGB2(14, 14, 7),    //CE1D
    RGB2(14, 14, 8),    //CE21
 ...
 * 2 minutes.                                   */
static const u16 gNightfallFilters[] = 
{
    RGB2(0, 14, 14),    //39C0
    RGB2(0, 14, 14),    //39C0
    RGB2(0, 14, 13),    //35C0
...
static const u16 gNightFilter = RGB2(14, 14, 6);   //19CE
