const u8 gTrainerClassNames[][13] = {
    [TRAINER_CLASS_PKMN_TRAINER_1] = _("Treinador {PKMN}"),
    [TRAINER_CLASS_PKMN_TRAINER_2] = _("Treinador {PKMN}"),
    [TRAINER_CLASS_HIKER] = _("Hiker"),
    [TRAINER_CLASS_TEAM_AQUA] = _("Team Aqua"),
    [TRAINER_CLASS_PKMN_BREEDER] = _("Breeder {PKMN}"),
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = _("Team Aqua"),
    ...
    [TRAINER_CLASS_RIVAL] = _("Treinador {PKMN}"),
    ...
    [TRAINER_CLASS_RS_PROTAG] = _("Treinador {PKMN}"),
};
