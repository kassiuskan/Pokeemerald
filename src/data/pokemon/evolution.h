const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_KADABRA]               = {{EVO_ITEM, 0, SPECIES_ALAKAZAM},
									   {EVO_ITEM, ITEM_LINK_STONE, SPECIES_ALAKAZAM}},
    ...
    [SPECIES_MACHOKE]               = {{EVO_TRADE, 0, SPECIES_MACHAMP},
									   {EVO_ITEM, ITEM_LINK_STONE, SPECIES_MACHAMP}},
    ...
    [SPECIES_GRAVELER]              = {{EVO_TRADE, 0, SPECIES_GOLEM},
									   {EVO_ITEM, ITEM_LINK_STONE, SPECIES_GOLEM}},
    ...
    [SPECIES_HAUNTER]               = {{EVO_TRADE, 0, SPECIES_GENGAR},
									   {EVO_ITEM, ITEM_LINK_STONE, SPECIES_GENGAR}},
    ...
    [SPECIES_KOFFING]               = {{EVO_LEVEL, 35, SPECIES_WEEZING},
										{EVO_SPECIFIC_MON_IN_PARTY, SPECIES_SINISTEA, SPECIES_WEEZING_GALARIAN}},
    ...
    [SPECIES_BOLDORE]               = {{EVO_TRADE, 0, SPECIES_GIGALITH},
									   {EVO_ITEM, ITEM_LINK_STONE, SPECIES_GIGALITH}},
    ...
    [SPECIES_GURDURR]               = {{EVO_TRADE, 0, SPECIES_CONKELDURR},
									   {EVO_ITEM, ITEM_LINK_STONE, SPECIES_CONKELDURR}},
    ...
    [SPECIES_PHANTUMP]              = {{EVO_TRADE, 0, SPECIES_TREVENANT},
									   {EVO_ITEM, ITEM_LINK_STONE, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]             = {{EVO_TRADE, 0, SPECIES_GOURGEIST},
									   {EVO_ITEM, ITEM_LINK_STONE, SPECIES_GOURGEIST}},
	...
	[SPECIES_MELTAN]				= {{EVO_ITEM_HOLD_DAY, ITEM_METAL_COAT, SPECIES_MELMETAL},
									   {EVO_ITEM_HOLD_NIGHT, ITEM_METAL_COAT, SPECIES_MELMETAL}},
    ...
    [SPECIES_KUBFU]                 = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_URSHIFU},
    ...
    [SPECIES_FARFETCHD_GALARIAN]    = {{EVO_ITEM_HOLD_DAY, ITEM_LEEK, SPECIES_SIRFETCHD},
										{EVO_ITEM_HOLD_NIGHT, ITEM_LEEK, SPECIES_SIRFETCHD}},
    ...
    [SPECIES_YAMASK_GALARIAN]       = {{EVO_ITEM_HOLD_DAY, ITEM_SPELL_TAG, SPECIES_RUNERIGUS},
										{EVO_ITEM_HOLD_NIGHT, ITEM_SPELL_TAG, SPECIES_RUNERIGUS}},
    ...
    [SPECIES_PUMPKABOO_SMALL]       = {{EVO_TRADE, 0, SPECIES_GOURGEIST_SMALL},
									   {EVO_ITEM, ITEM_LINK_STONE, SPECIES_GOURGEIST_SMALL}},
    [SPECIES_PUMPKABOO_LARGE]       = {{EVO_TRADE, 0, SPECIES_GOURGEIST_LARGE},
									   {EVO_ITEM, ITEM_LINK_STONE, SPECIES_GOURGEIST_LARGE}},
    [SPECIES_PUMPKABOO_SUPER]       = {{EVO_TRADE, 0, SPECIES_GOURGEIST_SUPER},
									   {EVO_ITEM, ITEM_LINK_STONE, SPECIES_GOURGEIST_SUPER}},
