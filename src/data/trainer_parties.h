...
static const struct TrainerMonNoItemCustomMoves sParty_Berke[] = {
    {
    .iv = 255,
    .lvl = 26,
...
static const struct TrainerMonNoItemCustomMoves sParty_Mary[] = {
    {
    .iv = 255,
    .lvl = 26,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ACID, MOVE_CONFUSE_RAY, MOVE_INGRAIN, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 12,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METAL_CLAW, MOVE_SMACK_DOWN, MOVE_WATER_GUN, MOVE_ROCK_TOMB}
    },
    {
    .iv = 0,
    .lvl = 12,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STEALTH_ROCK, MOVE_SANDSTORM, MOVE_ABSORB, MOVE_AQUA_JET}
    },
    {
    .iv = 200,
    .lvl = 15,
    ...
    .moves = {MOVE_BLOCK, MOVE_ROCK_THROW, MOVE_THUNDER_WAVE, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Joey[] = {
    {
    .iv = 0,
    .lvl = 9,
    .species = SPECIES_ABRA,
...
static const struct TrainerMonNoItemCustomMoves sParty_James1[] = {
    {
    .iv = 0,
    .lvl = 6,
    .species = SPECIES_SILCOON,
    .moves = {MOVE_STRING_SHOT, MOVE_TACKLE, MOVE_POISON_STING, MOVE_HARDEN}
    },
    {
    .iv = 0,
    .lvl = 6,
